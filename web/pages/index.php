<?php
        ...
        // $results = $db->query('SELECT * FROM plus, vue');
        // $req = $bdd->prepare('SELECT * FROM vue WHERE photo = :photo AND alt <= :alt');
        // $req = $bdd->prepare('SELECT * FROM plus WHERE titre = :titre AND description <= :description');

        // $req->execute(array('photo' => $_GET['photo'], 'alt' => $_GET['alt']));
        // $req->execute(array('titre' => $_GET['titre'], 'description' => $_GET['description']));
